...
public class StatisticUtilsArrayTests {
    private StatisticUtilsArray sUArray;
    ...
    public void testGetMin(double[] doublesArray, double expectedOutput) {
        sUArray = new StatisticUtilsArray(doublesArray);
    ...
    private static Stream<Arguments> testGetSd() {
        return Stream.of(
                arguments(new double[]{1,3,3,3,2,5,8,7,8,9},2.8848262031225076),
                arguments(new double[]{8,9,5,3,6,5,1,1,0},3.192874010111336),
                arguments(new double[]{10,30,30,30,20,50,80,70,80,90},28.848262031225072),
                arguments(new double[]{0,0,0,0,0,0,0,0},0),
