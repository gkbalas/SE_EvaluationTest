...
public class StatisticUtilsArrayListStreamTests {
    private StatisticUtilsArrayListStream sUArrayList;
    ...
    public void testGetMin(ArrayList<Integer> doublesArray, double expectedOutput) {
        sUArrayList = new StatisticUtilsArrayListStream(doublesArray);
    ...
    private static Stream<Arguments> testGetSd() {
        return Stream.of(
                arguments(new ArrayList<Integer>(Arrays.asList(1,3,3,3,2,5,8,7,8,9)),2.7367864366808017),
                arguments(new ArrayList<Integer>(Arrays.asList(8,9,5,3,6,5,1,1,0)),3.010270485365348),
                arguments(new ArrayList<Integer>(Arrays.asList(10,30,30,30,20,50,80,70,80,90)),27.367864366808018),
                arguments(new ArrayList<Integer>(Arrays.asList(0,0,0,0,0,0,0,0)),0),
